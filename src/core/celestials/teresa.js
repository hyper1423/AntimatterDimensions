...
export const Teresa = {
  ...
  rewardMultiplier(antimatter) {
    return Decimal.max(Decimal.pow(antimatter.plus(1).log10().div(1.5e8), 12), 1).toNumber();
  },
  get pouredAmount() {
  ...
  get possibleFill() {
    return Math.min(Currency.realityMachines.value.plus(this.pouredAmount).log10().div(24), 1);
  },
  get rmMultiplier() {
