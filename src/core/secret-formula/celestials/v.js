...
export const v = {
  ...
  mainUnlock: {
    ...
    eternities: {
      ...
      requirement: 1e70,
      format: x => format(x, 2),
      progress: () => emphasizeEnd(Currency.eternities.value.pLog10().div(70).toNumber()),
    },
    infinities: {
      id: 3,
      name: "Infinities",
      ...
      requirement: 1e160,
      format: x => format(x, 2),
      progress: () => emphasizeEnd(Currency.infinitiesTotal.value.pLog10().div(160).toNumber()),
    },
    dilatedTime: {
      id: 4,
      name: "Dilated Time",
      ...
      requirement: DC.E320,
      format: x => format(x, 2),
      progress: () => emphasizeEnd(player.records.thisReality.maxDT.pLog10().div(320).toNumber()),
    },
    replicanti: {
      id: 5,
      name: "Replicanti",
      ...
      format: x => format(x, 2),
      progress: () => emphasizeEnd(player.records.thisReality.maxReplicanti.pLog10().div(320000).toNumber()),
    },
    realityMachines: {
      id: 6,
      ...
      requirement: 1e60,
      format: x => format(x, 2),
      progress: () => emphasizeEnd(Currency.realityMachines.value.pLog10().div(60).toNumber()),
    },
  },
  runUnlocks: [
    {
    ...
    },
    {
      ...
      currentValue: () => Currency.infinityPoints.value.log10().toNumber(),
    ...
    },
    {
      ...
      currentValue: () => Currency.antimatter.value.log10().toNumber(),
    ...
    },
    {
      ...
      condition: () => V.isRunning,
      currentValue: () => Currency.eternityPoints.value.log10().toNumber(),
      formatRecord: x => format(Decimal.pow10(x), 2),
