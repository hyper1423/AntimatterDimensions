...
export const breakInfinityUpgrades = {
  totalAMMult: {
    ...
    effect: () => Decimal.pow(player.records.totalAntimatter.spLog10().floor().plus(1), 0.5),
  ...
  currentAMMult: {
    ...
    effect: () => Decimal.pow(Currency.antimatter.value.spLog10().floor().plus(1), 0.5),
    formatEffect: value => formatX(value, 2, 2)
  },
  galaxyBoost: {
    id: "postGalaxy",
  ...
  infinitiedMult: {
    ...
    effect: () => (Currency.infinitiesTotal.value.eq(0) ? DC.D0 : Currency.infinitiesTotal.value.pLog10()).times(10).plus(1),
    formatEffect: value => formatX(value, 2, 2)
  },
  achievementMult: {
    id: "achievementMult",
