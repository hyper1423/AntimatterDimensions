...
export const eternityChallenges = [
  ...
  },
  {
    ...
    reward: {
      ...
      effect: completions => {
        const infinityPower = Decimal.log10(Currency.infinityPower.value.pLog10().plus(1));
        return Decimal.max(0, Decimal.pow(infinityPower, 0.03 * completions).minus(1)).toNumber();
      },
